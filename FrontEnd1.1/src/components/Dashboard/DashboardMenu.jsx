...
const DashboardMenu = () => {
    ...
    const placeOnlineUsers = async () => {
        ...
        const addedCards = [...new Set(data.map(element => element.username))]; // Convertir Set a Array directamente
        setUsersCard(addedCards); // Actualizar estado con el nuevo array
    };
